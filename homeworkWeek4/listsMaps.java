...
public class listsMaps {
	...
	public static void main(String[] args) {
		...
		List<String> employeeNames = new ArrayList<String>();
				...
				/*
				 * 5. Create a variable int i = 0; then iterate over ids using an enhanced for
				...
				/*
				 * 8. Iterate over the ids HashSet and append each id, followed by a dash “-“ to
				 * idsBuilder.
				 */
				for (int id : ids) {
